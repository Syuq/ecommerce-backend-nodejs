...
class DiscountService {
  static async createDiscount(payload) {
    ...
    if (new Date(start_date) >= new Date(end_date)) {
      throw new BadRequest('Start date must be before end_date code has expired!');
    }
    ...
    const newDiscount = await discount.create({
      ...
      discount_start_date: new Date(start_date), // day start
      discount_end_date: new Date(end_date), // day end
      discount_max_uses: max_uses, // number of discounts applied
      discount_uses_count: uses_count, // number of discounts used
